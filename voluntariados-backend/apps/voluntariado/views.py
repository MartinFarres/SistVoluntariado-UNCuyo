...
import threading
from .notifications import check_and_notify_activation
...
class InscripcionConvocatoriaViewSet(viewsets.ModelViewSet):
    ...
    def aceptar(self, request, pk=None):
        ...
        # Si con este cambio el voluntariado pasa a "Activo" y aún no se notificó, enviar notificaciones
        voluntariado = getattr(inscripcion, 'voluntariado', None)
        if voluntariado is not None:
            check_and_notify_activation(voluntariado)
    ...
    def rechazar(self, request, pk=None):
        ...
        # Re-evaluar si el voluntariado quedó en estado Activo luego de resolver pendientes
        voluntariado = getattr(inscripcion, 'voluntariado', None)
        if voluntariado is not None:
            check_and_notify_activation(voluntariado)
